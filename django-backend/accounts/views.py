...
def login_view(request):
    ...
    """
    logger.info(f"accounts/views/login_view <<A Request has been made>>")
    ...
    if user and user.check_password(password):
        ...
        return Response({
            ...
            "token":  "dummy token", # str(refresh.access_token),
            # "refresh": str(refresh),
            "user": {
                "id": user.id,
...
def register_view(request):
    ...
    """
    logger.info(f"accounts/views/register_view <<A Request has been made>>")
